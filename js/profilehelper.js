...
function showRoutes(routes,t,h){
	...
	for (i; i < h; i++) {
      ...
      var routeInfo = "<a href='../routeviewer/?id="+r['routeID']+"'><div class='routeInfo' id='routeOverlay"+i+"'><p>Time: "+time+"</p><p>Distance: "+distance+"km</p></div></a>"
