<?php
	...
	$query = 'WHERE ('.$groupFriendOrPublic.''.addParam('RideType',$rideType,$and).''.addParam('Level',$level,'AND').''.$timeRangeQuery.') '; //try replacing $groupFriendOrPublic with (CreatorType = 0 OR CreatorType = 1) if getting errors
